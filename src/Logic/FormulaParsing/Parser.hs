...
happyExpList = Happy_Data_Array.listArray (0,32) ([2944,256,14336,47104,0,33504,35,28672,11777,1472,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_happyFormula","fmla","cj","dj","im","ng","fm","'('","')'","atm","%eof"]
...
action_3 (5) = happyShift action_9
...
action_7 (5) = happyShift action_9
...
action_12 (5) = happyFail []
action_12 (6) = happyFail []
action_12 (7) = happyFail []
action_12 _ = happyReduce_4

action_13 (5) = happyFail []
action_13 (6) = happyFail []
action_13 (7) = happyFail []
action_13 _ = happyReduce_3

action_14 (5) = happyFail []
action_14 (6) = happyFail []
...
happyNewToken action sts stk (tk:tks) =
	...
	TokLPar -> cont 10;
	TokRPar -> cont 11;
	TokAtom happy_dollar_dollar -> cont 12;
	_ -> happyError' ((tk:tks), [])
	}
...
happyError' :: () => ([(Token)], [Prelude.String]) -> Hap a
