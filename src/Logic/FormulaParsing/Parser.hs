...
happyTokenStrings = ["cj","dj","im","ng","fm","vm","'('","')'","atm","%eof"]

happyActOffsets :: HappyAddr
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#

happyDefActions :: HappyAddr
happyDefActions = HappyA# ""#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyRuleArr = HappyA# ""#
...
happyReduction_1 (HappyTerminal (TokAtom happy_var_1))
         =  HappyAbsSyn5
                 (A . At . pack $ happy_var_1
        )
...
happyReduction_2 (HappyAbsSyn5  happy_var_3)
        ...
        (HappyAbsSyn5  happy_var_1)
         =  HappyAbsSyn5
                 (B Conjunction happy_var_1 happy_var_3
        )
...
happyReduction_3 (HappyAbsSyn5  happy_var_3)
        ...
        (HappyAbsSyn5  happy_var_1)
         =  HappyAbsSyn5
                 (B Disjunction happy_var_1 happy_var_3
        )
...
happyReduction_4 (HappyAbsSyn5  happy_var_3)
        ...
        (HappyAbsSyn5  happy_var_1)
         =  HappyAbsSyn5
                 (B Implication happy_var_1 happy_var_3
        )
...
happyTerminalToTok term = case term of {
        ...
        TokLPar -> 8#;
        TokRPar -> 9#;
        TokAtom happy_dollar_dollar -> 10#;
        _ -> -1#;
        }
...
happyThen :: () => (Hap a) -> (a -> (Hap b)) -> (Hap b)
happyThen = ((>>=))
happyReturn :: () => a -> (Hap a)
happyReturn = (return)
happyThen1 m k tks = ((>>=)) m (\a -> k a tks)
happyFmap1 f m tks = happyThen (m tks) (\a -> happyReturn (f a))
happyReturn1 :: () => a -> b -> (Hap a)
happyReturn1 = \a tks -> (return) a
happyReport' :: () => [(Token)] -> [Happy_Prelude.String] -> ([(Token)] -> (Hap a)) -> (Hap a)
happyReport' = (\tokens expected resume -> (parseError) tokens)

happyAbort :: () => [(Token)] -> (Hap a)
happyAbort = Happy_Prelude.error "Called abort handler in non-resumptive parser"

happyFormula tks = happySomeParser where
